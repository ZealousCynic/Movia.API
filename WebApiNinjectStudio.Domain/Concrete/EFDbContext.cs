...
namespace WebApiNinjectStudio.Domain.Concrete
{
    public class EFDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //    .HasKey(rbs => new { rbs.ID, rbs.RouteID, rbs.BusStopID });
            ...
            modelBuilder.Entity<RouteBusStop>().HasData(
                ...
                new { ID = 16, RouteID = 6, BusStopID = 78, Order = 1, IsDeleted = false },
                new { ID = 17, RouteID = 6, BusStopID = 79, Order = 2, IsDeleted = false },
                new { ID = 18, RouteID = 6, BusStopID = 80, Order = 3, IsDeleted = false },
                new { ID = 19, RouteID = 6, BusStopID = 81, Order = 4, IsDeleted = false },
                new { ID = 20, RouteID = 6, BusStopID = 82, Order = 5, IsDeleted = false },
                new { ID = 21, RouteID = 6, BusStopID = 83, Order = 6, IsDeleted = false },
                new { ID = 22, RouteID = 6, BusStopID = 84, Order = 7, IsDeleted = false },
                new { ID = 23, RouteID = 6, BusStopID = 85, Order = 8, IsDeleted = false },
                new { ID = 24, RouteID = 6, BusStopID = 86, Order = 9, IsDeleted = false },
                new { ID = 25, RouteID = 6, BusStopID = 87, Order = 10, IsDeleted = false },
                new { ID = 26, RouteID = 6, BusStopID = 88, Order = 11, IsDeleted = false },
                new { ID = 27, RouteID = 6, BusStopID = 89, Order = 12, IsDeleted = false },
                new { ID = 28, RouteID = 6, BusStopID = 90, Order = 13, IsDeleted = false },
                new { ID = 29, RouteID = 6, BusStopID = 91, Order = 14, IsDeleted = false },
                new { ID = 30, RouteID = 6, BusStopID = 92, Order = 15, IsDeleted = false },
                #endregion

                #region 401A Mod Campus (Bengerds Allé)
                new { ID = 31, RouteID = 1, BusStopID = 1, Order = 1, IsDeleted = false },
                new { ID = 32, RouteID = 1, BusStopID = 2, Order = 2, IsDeleted = false },
                new { ID = 33, RouteID = 1, BusStopID = 3, Order = 3, IsDeleted = false },
                new { ID = 34, RouteID = 1, BusStopID = 4, Order = 4, IsDeleted = false },
                new { ID = 35, RouteID = 1, BusStopID = 5, Order = 5, IsDeleted = false },
                new { ID = 36, RouteID = 1, BusStopID = 6, Order = 6, IsDeleted = false },
                new { ID = 37, RouteID = 1, BusStopID = 7, Order = 7, IsDeleted = false },
                new { ID = 38, RouteID = 1, BusStopID = 8, Order = 8, IsDeleted = false },
                new { ID = 39, RouteID = 1, BusStopID = 9, Order = 9, IsDeleted = false },
                new { ID = 40, RouteID = 1, BusStopID = 10, Order = 10, IsDeleted = false },
                new { ID = 41, RouteID = 1, BusStopID = 11, Order = 11, IsDeleted = false },
                new { ID = 42, RouteID = 1, BusStopID = 12, Order = 12, IsDeleted = false },
                new { ID = 43, RouteID = 1, BusStopID = 13, Order = 13, IsDeleted = false },
                new { ID = 44, RouteID = 1, BusStopID = 14, Order = 14, IsDeleted = false },
                new { ID = 45, RouteID = 1, BusStopID = 15, Order = 15, IsDeleted = false },
                new { ID = 46, RouteID = 1, BusStopID = 16, Order = 16, IsDeleted = false },
                new { ID = 47, RouteID = 1, BusStopID = 17, Order = 17, IsDeleted = false },
                new { ID = 48, RouteID = 1, BusStopID = 18, Order = 18, IsDeleted = false },
                new { ID = 49, RouteID = 1, BusStopID = 19, Order = 19, IsDeleted = false },
                #endregion
                #region 401A Mod Benløseparken Øst (Benløseparken)
                new { ID = 50, RouteID = 2, BusStopID = 19, Order = 1, IsDeleted = false },
                new { ID = 51, RouteID = 2, BusStopID = 20, Order = 2, IsDeleted = false },
                new { ID = 52, RouteID = 2, BusStopID = 21, Order = 3, IsDeleted = false },
                new { ID = 53, RouteID = 2, BusStopID = 22, Order = 4, IsDeleted = false },
                new { ID = 54, RouteID = 2, BusStopID = 23, Order = 5, IsDeleted = false },
                new { ID = 55, RouteID = 2, BusStopID = 24, Order = 6, IsDeleted = false },
                new { ID = 56, RouteID = 2, BusStopID = 25, Order = 7, IsDeleted = false },
                new { ID = 57, RouteID = 2, BusStopID = 26, Order = 8, IsDeleted = false },
                new { ID = 58, RouteID = 2, BusStopID = 27, Order = 9, IsDeleted = false },
                new { ID = 59, RouteID = 2, BusStopID = 28, Order = 10, IsDeleted = false },
                new { ID = 60, RouteID = 2, BusStopID = 29, Order = 11, IsDeleted = false },
                new { ID = 61, RouteID = 2, BusStopID = 30, Order = 12, IsDeleted = false },
                new { ID = 62, RouteID = 2, BusStopID = 31, Order = 13, IsDeleted = false },
                new { ID = 63, RouteID = 2, BusStopID = 32, Order = 14, IsDeleted = false },
                new { ID = 64, RouteID = 2, BusStopID = 33, Order = 15, IsDeleted = false },
                new { ID = 65, RouteID = 2, BusStopID = 34, Order = 16, IsDeleted = false },
                new { ID = 66, RouteID = 2, BusStopID = 35, Order = 17, IsDeleted = false },
                new { ID = 67, RouteID = 2, BusStopID = 36, Order = 18, IsDeleted = false },
                new { ID = 68, RouteID = 2, BusStopID = 37, Order = 19, IsDeleted = false },
                #endregion

                #region 55E Mod Malmparken St.
                new { ID = 69, RouteID = 3, BusStopID = 38, Order = 1, IsDeleted = false },
                new { ID = 70, RouteID = 3, BusStopID = 39, Order = 2, IsDeleted = false },
                new { ID = 71, RouteID = 3, BusStopID = 40, Order = 3, IsDeleted = false },
                new { ID = 72, RouteID = 3, BusStopID = 41, Order = 4, IsDeleted = false },
                new { ID = 73, RouteID = 3, BusStopID = 42, Order = 5, IsDeleted = false },
                new { ID = 74, RouteID = 3, BusStopID = 43, Order = 6, IsDeleted = false },
                new { ID = 75, RouteID = 3, BusStopID = 44, Order = 7, IsDeleted = false },
                new { ID = 76, RouteID = 3, BusStopID = 45, Order = 8, IsDeleted = false },
                new { ID = 77, RouteID = 3, BusStopID = 46, Order = 9, IsDeleted = false },
                new { ID = 78, RouteID = 3, BusStopID = 47, Order = 10, IsDeleted = false },
                new { ID = 79, RouteID = 3, BusStopID = 48, Order = 11, IsDeleted = false },
                new { ID = 80, RouteID = 3, BusStopID = 49, Order = 12, IsDeleted = false },
                new { ID = 81, RouteID = 3, BusStopID = 50, Order = 13, IsDeleted = false },
                #endregion
                #region 55E Mod Allerød St.
                new { ID = 82, RouteID = 4, BusStopID = 50, Order = 1, IsDeleted = false },
                new { ID = 83, RouteID = 4, BusStopID = 51, Order = 2, IsDeleted = false },
                new { ID = 84, RouteID = 4, BusStopID = 52, Order = 3, IsDeleted = false },
                new { ID = 85, RouteID = 4, BusStopID = 53, Order = 4, IsDeleted = false },
                new { ID = 86, RouteID = 4, BusStopID = 54, Order = 5, IsDeleted = false },
                new { ID = 87, RouteID = 4, BusStopID = 55, Order = 6, IsDeleted = false },
                new { ID = 88, RouteID = 4, BusStopID = 56, Order = 7, IsDeleted = false },
                new { ID = 89, RouteID = 4, BusStopID = 57, Order = 8, IsDeleted = false },
                new { ID = 90, RouteID = 4, BusStopID = 58, Order = 9, IsDeleted = false },
                new { ID = 91, RouteID = 4, BusStopID = 59, Order = 10, IsDeleted = false },
                new { ID = 92, RouteID = 4, BusStopID = 60, Order = 11, IsDeleted = false },
                new { ID = 93, RouteID = 4, BusStopID = 61, Order = 12, IsDeleted = false },
                new { ID = 94, RouteID = 4, BusStopID = 62, Order = 13, IsDeleted = false }
                #endregion
            );
            #endregion
